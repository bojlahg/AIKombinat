...
export function createSchedule(
  projectId: string,
  data: { title: string; description?: string; cron_expression?: string; cli_tool?: string; cli_model?: string; cli_effort?: string | null; agent_profile_id?: string | null; effort_level?: number | null; skip_if_running?: boolean; schedule_type?: string; run_at?: string }
): Promise<Schedule> {
