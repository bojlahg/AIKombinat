import type { Todo, TodoExecutionRound } from '../db/queries.js';
...
export type WSEvent =
  ...
  | { type: 'todo:round-updated'; todoId: string; round: TodoExecutionRound }
  ...
  | { type: 'forum:status-changed'; forumId: string; status: string; currentCycle: number; currentMemberId: string | null }
